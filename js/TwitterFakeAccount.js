class TwitterFakeAccount
{
    ...
    doWarningAlert(objData)
    {
        ...
        for(var intCounter = 0; intCounter < objNodes.length; intCounter++) {
            ...
            objAlertDiv.innerHTML += "<a href='https://twitter.com/i/safety/report_story?client_referer=/&profile_id="+ objData.userId +"&reported_user_id="+ objData.userId +"' target='_blank' style='text-decoration:underline;text-decoration-style:dotted;color:rgba(249, 245, 187, 1);font-size:7pt;padding-left:5px;'>REPORT</a>";
